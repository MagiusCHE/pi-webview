...
- **IDE and browser integration**: the same UI in **VS Code**, **Visual Studio 2022/2026** and a **Chrome Side Panel**. Chrome shows the active page’s favicon/title/URL and selection, can atomically move an existing standalone session into the panel, and exposes consent-gated DOM, viewport-screenshot and structured page-action tools to the agent
